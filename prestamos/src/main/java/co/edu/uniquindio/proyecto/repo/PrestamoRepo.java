...
import co.edu.uniquindio.proyecto.dto.PrestamoQueryDTO;
...
public interface PrestamoRepo extends JpaRepository<Prestamo, Long> {
    ...
    @Query("select new co.edu.uniquindio.proyecto.dto.PrestamoQueryDTO(p.codigo, p.codigoCliente, l, p.fechaPrestamo, p.fechaDevolucion) from Prestamo p join p.isbnLibros l where p.codigoCliente = :codigoCliente")
